...
public class ShopsResource extends ServerResource {
    ...
    protected Representation get() throws ResourceException {
        ...
        List<Shop> shops = dataAccess.getShops(new Limits(localStart, localCount));

        //filter with status--------------------------------------------------------

        if(strStatus.equals("ACTIVE")){

          // we keep in the list only shops that have withdrawn value = 0
        ...
        //---------------------------------------------------------------------
        map.put("total", String.valueOf(shops.size()));
        map.put("shops", shops);
    ...
    protected Representation post(Representation entity) throws ResourceException {
        ...
        else if(user_token.equals("321BB")){
        ...
        Shop shop = dataAccess.addShop(name, address, lng2, lat2, withdrawn, tags);
